 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN, SFASSET_YOUWIN, SFASSET_BACKGROUND, SFASSET_FENCE};
...
public:
  ...
  virtual void      GetAssetWidth();
  virtual SFAssetId GetId();
  virtual void      OnRender();
  virtual void      GoEast();
  virtual void      GoWest();
  virtual void      GoEastB();
  virtual void      GoWestB();
